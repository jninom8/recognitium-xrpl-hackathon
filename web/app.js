...
import { journeyPanel, operationHistory, setupSummary, proofCards } from '/journey-view.mjs';
...
function render() {
  ...
  $('export-note').textContent = recorded ? 'The bundle permits offline checks. Use the repository verifier for fresh receipt-authority and XRPL checks.' : 'A fresh request export must be produced from its isolated run directory by the local operator. This link never exports the selected live request.';
