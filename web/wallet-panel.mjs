...
export class WalletReadings {
  ...
  async read(r,mode,fetcher=fetch) {
    ...
    try{
      const response=await fetcher('/api/requests/'+encodeURIComponent(r.agreement.requestId)+'/balance?mode='+mode,{signal:AbortSignal.timeout(20000)});
