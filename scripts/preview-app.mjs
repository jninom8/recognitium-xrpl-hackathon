...
const assets=new Set(['index.html','customer.css','customer.js','customer-model.mjs','state-client.mjs','operator.html','app.js','style.css','journey-model.mjs','journey-view.mjs','journey.css','wallet-panel.mjs','assistant.js','conversation.css']);
