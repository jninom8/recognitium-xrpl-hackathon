...
for(const file of files){
  ...
  for(const name of ['RECOGNITIUM_API_KEY','PROTOTYPE_BROKER_TOKEN','PROTOTYPE_BORROWER_TOKEN','PROTOTYPE_OPERATOR_TOKEN','HOSTED_BORROWER_TOKEN','HOSTED_BROKER_TOKEN','BLOB_READ_WRITE_TOKEN','VERCEL_OIDC_TOKEN']){
